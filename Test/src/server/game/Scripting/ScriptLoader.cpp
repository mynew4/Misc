/*
 * Copyright (C) 2013 Holysemu <http://www.Holysemu.org/>
 *
...
void AddSC_boss_council_of_ascendants();
...
void AddSC_boss_azil();                      //The Stonecore
...
void AddSC_boss_deathwings_back();          //CoT Dragon Soul
void AddSC_boss_deathwings_nightmare();
...
void AddSC_boss_asira();
void AddSC_boss_benedictus();
void AddSC_instance_hour_of_twilight();
void AddSC_boss_azshara();                  //CoT Well Of Eternity
void AddSC_boss_manoroth();
void AddSC_boss_perotharn();
void AddSC_instance_well_of_eternity();
void AddSC_dire_maul();			     //Dire Maul
void AddSC_instance_dire_maul();
void AddSC_boss_alysrazar();		     //Firelands
...
void AddSC_boss_anraphet();		     //Halls Of Origination
void AddSC_boss_earthrager_ptah();
void AddSC_boss_temple_guardian_anhuur();
void AddSC_instance_halls_of_origination();
void AddSC_boss_barim();	     	     //Lost City Of The Tol'vir
...
void AddSC_boss_altairus();		     //The Vortex Pinnacle
...
void AddSC_tol_barad_peninsula();
...
void AddEasternKingdomsScripts()
{
    ...
    AddSC_boss_chogall();
    AddSC_boss_council_of_ascendants();
...
void AddKalimdorScripts()
{
    ...
    AddSC_boss_deathwings_back();          //CoT Dragon Soul
    AddSC_boss_deathwings_nightmare();
    ...
    AddSC_boss_anraphet();		    //Halls Of Origination
    AddSC_boss_earthrager_ptah();
    AddSC_boss_temple_guardian_anhuur();
    AddSC_instance_halls_of_origination();
    AddSC_boss_barim();	    		    //Lost City Of the Tolvir
    AddSC_boss_lockmaw();
    AddSC_boss_siamat();
    AddSC_boss_ussam();
    ...
    AddSC_boss_altairus();		    //The Vortex Pinnacle
    AddSC_boss_assad();
