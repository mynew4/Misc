...
void World::LoadConfigSettings(bool reload)
{
	...
	//Wintergrasp
    m_bool_configs[CONFIG_WINTERGRASP_ENABLE] = ConfigMgr::GetIntDefault("OutdoorPvP.Wintergrasp.Enabled", true);
    ...
    m_bool_configs[CONFIG_OUTDOORPVP_WINTERGRASP_CUSTOM_HONOR] = ConfigMgr::GetIntDefault("OutdoorPvP.Wintergrasp.CustomHonorRewards", false);
    ...
    m_bool_configs[CONFIG_CONFIG_OUTDOORPVP_WINTERGRASP_ANTIFARM_ENABLE] = ConfigMgr::GetIntDefault("OutdoorPvP.Wintergrasp.Antifarm.Enable", true);
