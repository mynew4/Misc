...
#define MIN_holysemu_string_ID           1                    // 'holysemu_string'
#define MAX_holysemu_string_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_holysemu_string_ID // 'db_script_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadTrinityStrings() { return LoadTrinityStrings("holysemu_string", MIN_holysemu_string_ID, MAX_holysemu_string_ID); }
