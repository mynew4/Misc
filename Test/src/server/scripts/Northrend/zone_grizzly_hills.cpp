...
#define SAY_FREED               "Est-ce vraiment possible ? Libre, après tant d'années ?"
#define GOSSIP_TEXT_GET_WEAPON  "Ravi de vous avoir aidé, ma dame. Vous souvenez-vous de cette épée légendaire dont je vous avait déjà parlé ? Sauriez-vous où je pourrais la trouver ?"
