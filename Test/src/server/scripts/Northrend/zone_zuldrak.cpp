...
const char* SAY_RAGECLAW_1 =      "Les trolls, c'est caca !";
const char* SAY_RAGECLAW_2 =      "ARRRROOOOGGGGAAAA!";
const char* SAY_RAGECLAW_3 =      "Le varleu se rebiffe !";
...
#define GOSSIP_BLOODROSE                 "Stefan m'a dit que vous vouliez démontrer la puissance de cet artefact."
#define TEXT1                            "Effectivement. Regardez bien, $R."
#define TEXT2                            "Tiens, troll… un cadeau "
#define TEXT3                            "Pour moi ? Vraiment ?"
#define TEXT4                            "C'est....c'est magnifique !"
#define TEXT5                            "Beeerk… Dégoûtant !"
...
#define GOSSIP_LEAVING                      "Soldat, voici vos ordres. Repliez-vous et allez faire votre rapport au sergent !"
