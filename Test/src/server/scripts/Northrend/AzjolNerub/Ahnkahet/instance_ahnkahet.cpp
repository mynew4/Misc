    ...
    
		{
        ...
        
			{
            ...
            
				{
					...
					case 29309: Elder_Nadox = creature->GetGUID();                     
						break;
                
					case 29308: Prince_Taldaram = creature->GetGUID();                 
						break;
                
					case 29310: Jedoga_Shadowseeker = creature->GetGUID();             
						break;
                
					case 29311: Herald_Volazj = creature->GetGUID();                   
						break;
                
					case 30258: Amanitar = creature->GetGUID();                        
						break;
                
					case 30114: InitiandGUIDs.insert(creature->GetGUID());             
						break;
 ...
 Prince_TaldaramGate = go->GetGUID();                   
        ...
        
			{
            ...
            
				{
					...
					case DATA_SPHERE1:                    
						return Prince_TaldaramSpheres[0];
                
					case DATA_SPHERE2:                    
						return Prince_TaldaramSpheres[1];
        ...
        
			{
				...
				OUT_SAVE_INST_DATA;
					...
					saveStream 
						<< "A K " << m_auiEncounter[0] << ' ' << m_auiEncounter[1] << ' '
