...
public:
	spell_pri_flash_heal() :
			SpellScriptLoader("spell_pri_flash_heal") {
	}
	...
	class spell_pri_flash_heal_SpellScript: public SpellScript {
		...
		void Register() {
			OnEffectHitTarget += SpellEffectFn(spell_pri_flash_heal_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_HEAL);
		}
	};
