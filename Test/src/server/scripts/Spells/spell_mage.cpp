...
enum MageSpells
{
	...
	SPELL_MAGE_ICE_BLOCK						 = 27619,
	SPELL_MAGE_ICE_LANCE						 = 46194,
	SPELL_MAGE_IGNITE                            = 12654,
	SPELL_MAGE_IMPROVED_MANA_GEM_TRIGGERED	     = 83098,
    SPELL_MAGE_INCANTERS_ABSORBTION_R1           = 44394,
    SPELL_MAGE_INCANTERS_ABSORBTION_TRIGGERED    = 44413,
    SPELL_MAGE_MASTER_OF_ELEMENTS_ENERGIZE       = 29077,
	SPELL_MAGE_POLYMORPH						 = 13323,
...
class spell_mage_incanters_absorbtion_base : public SpellScriptLoader
{
    public:
        spell_mage_incanters_absorbtion_base() : SpellScriptLoader("spell_mage_incanters_absorbtion_base") { }

        class spell_mage_incanters_absorbtion_base_AuraScript : public AuraScript
		{
            PrepareAuraScript(spell_mage_incanters_absorbtion_base_AuraScript);
			enum Spells
			{
				SPELL_MAGE_INCANTERS_ABSORBTION_TRIGGERED = 44413,
				SPELL_MAGE_INCANTERS_ABSORBTION_R1 = 44394,
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Player* player = caster->ToPlayer())
                {
                    ...
                    for (uint32 i = 0; i < MAX_GLYPH_SLOT_INDEX; ++i)
                        if (uint32 glyphId = player->GetGlyph(player->GetActiveSpec(),PLAYER_FIELD_GLYPH_SLOTS_1))
