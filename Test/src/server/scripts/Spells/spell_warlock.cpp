...
enum WarlockSpells
{
    ...
    SPELL_WARLOCK_GLYPH_OF_SHADOWFLAME		        = 63310,
...
public:
	...
	class spell_warl_immolate_SpellScript : public SpellScript {
		...
		void Register() {
			OnEffectHitTarget += SpellEffectFn(spell_warl_immolate_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
		}
	};
...
public:
	spell_warl_dark_intent() :
			SpellScriptLoader("spell_warl_dark_intent") {
	}
