...
class spell_gen_starsurge_cd_reset : public SpellScriptLoader
{
    public:
        spell_gen_starsurge_cd_reset() : SpellScriptLoader("spell_gen_starsurge_cd_reset") {}

        class spell_gen_starsurge_cd_reset_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_starsurge_cd_reset_SpellScript);

            bool Validate(SpellInfo const* /*spellEntry*/)
            {
                if (!sSpellStore.LookupEntry(SPELL_STARSURGE))
                    return false;
                return true;
            }
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                if (Player *caster = GetCaster()->ToPlayer())
                    if (caster->HasSpellCooldown(SPELL_STARSURGE))
                        caster->RemoveSpellCooldown(SPELL_STARSURGE, true);
            }

            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gen_starsurge_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_starsurge_cd_reset_SpellScript();
        }
};
...
// 77762 Lava Surge!
class spell_gen_lava_burst_cd_reset : public SpellScriptLoader
{
    public:
        spell_gen_lava_burst_cd_reset() : SpellScriptLoader("spell_gen_lava_burst_cd_reset") {}

        class spell_gen_lava_burst_cd_reset_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_lava_burst_cd_reset_SpellScript);

            bool Validate(SpellInfo const* /*spellEntry*/)
            {
                if (!sSpellStore.LookupEntry(SPELL_LAVA_BURST))
                    return false;
                return true;
            }
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gen_lava_burst_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_lava_burst_cd_reset_SpellScript();
        }
};
...
// 64343 Impact
class spell_gen_fire_blast_cd_reset : public SpellScriptLoader
{
    public:
        spell_gen_fire_blast_cd_reset() : SpellScriptLoader("spell_gen_fire_blast_cd_reset") {}

        class spell_gen_fire_blast_cd_reset_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_fire_blast_cd_reset_SpellScript);

            bool Validate(SpellInfo const* /*spellEntry*/)
            {
                if (!sSpellStore.LookupEntry(SPELL_FIRE_BLAST))
                    return false;
                return true;
            }
            ...
            {
                if (Player *caster = GetCaster()->ToPlayer())
                    if (caster->HasSpellCooldown(SPELL_FIRE_BLAST))
                        caster->RemoveSpellCooldown(SPELL_FIRE_BLAST, true);
            }

            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gen_fire_blast_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_fire_blast_cd_reset_SpellScript();
        }
};
enum ColossusSmashSpell
{
    SPELL_COLOSSUS_SMASH  = 86346,
};
// 52437 Sudden Death
class spell_gen_colossus_smash_cd_reset : public SpellScriptLoader
{
    public:
        spell_gen_colossus_smash_cd_reset() : SpellScriptLoader("spell_gen_colossus_smash_cd_reset") {}

        class spell_gen_colossus_smash_cd_reset_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_gen_colossus_smash_cd_reset_SpellScript);

            bool Validate(SpellInfo const* /*spellEntry*/)
            {
                if (!sSpellStore.LookupEntry(SPELL_COLOSSUS_SMASH))
                    return false;
                return true;
            }
            ...
            {
                if (Player *caster = GetCaster()->ToPlayer())
                    if (caster->HasSpellCooldown(SPELL_COLOSSUS_SMASH))
                        caster->RemoveSpellCooldown(SPELL_COLOSSUS_SMASH, true);
            }

            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_gen_colossus_smash_cd_reset_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_APPLY_AURA);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_gen_colossus_smash_cd_reset_SpellScript();
        }
};
...

{
    ...
    new spell_gen_colossus_smash_cd_reset();
    ...
    new spell_gen_fire_blast_cd_reset();
    ...
    new spell_gen_lava_burst_cd_reset();
    ...
    new spell_gen_starsurge_cd_reset();
