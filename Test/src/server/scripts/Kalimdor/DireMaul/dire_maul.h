...
#define MAX_ENCOUNTERS 12

enum
{
    MAX_GENERATORS              = 5, // East
    TYPE_ALZZIN                 = 0, // Do not change - Handled with Acid
    TYPE_ZEVRIM                 = 1,
    TYPE_IRONBARK               = 2, // West
    TYPE_WARPWOOD               = 3,
    TYPE_IMMOLTHAR              = 4,
    TYPE_PRINCE                 = 5,
    TYPE_PYLON_1                = 6,
    ...
    TYPE_PYLON_5                = TYPE_PYLON_1 + 4, // North
    TYPE_KING_GORDOK            = 11, // East
    ...
    NPC_IRONBARK_REDEEMED       = 14241, // West
    ...
    GO_WEST_LIBRARY_DOOR        = 179550, // North
...
class instance_dire_maul : public InstanceMapScript
{
    public:
        ...
        void Initialize();
        //void OnPlayerEnter(Map*, Player* pPlayer);
    ...
    protected:
        ...
        bool m_lFelvineShardGUIDs;
        // West
        bool m_aCrystalGeneratorGuid[MAX_GENERATORS];
        bool m_luiHighborneSummonerGUIDs;
        bool m_lGeneratorGuardGUIDs;
