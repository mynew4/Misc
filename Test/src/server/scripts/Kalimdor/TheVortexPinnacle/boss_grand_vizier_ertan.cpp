...
#define SAY_AGGRO "Animaux répugnants ! Votre présence à Mur-céleste ne sera pas tolérée !"
#define SAY_RANDOM "Dévasté !"
...
Position const LurkingTempestSummonPos[9] =
{
