...
public:
...

    {
...

        {
...

            {
                ...
                case LOCALE_deDE: localizedEntry = LOCALE_INNKEEPER_3;
		    break;
...

    {
...

        {
            ...
            case GOSSIP_ACTION_TRADE: player->GetSession()->SendListInventory(creature->GetGUID());
		break;

            case GOSSIP_ACTION_INN: player->SetBindPoint(creature->GetGUID()); 
		break;
