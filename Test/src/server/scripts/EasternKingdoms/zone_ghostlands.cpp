...
public:
 ...
 && pCreature->GetEntry() == MOB3)
        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 1) 
	{
            ...
            pCreature->GetMotionMaster()->MovePoint(0, 6640.259f, -6343.529f,
 8.944f);
        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 2) 
	{
            ...
            pCreature->GetMotionMaster()->MovePoint(0, 6437.597f, -6618.529f,
 107.436f);
        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 3) 
	{
            ...
            pCreature->GetMotionMaster()->MovePoint(0, 6306.514f, -6363.729f,
 78.024f);
...
public:
    ...
    npc_blood_knight_dawnstar() :
 CreatureScript("npc_blood_knight_dawnstar") {
    }
 ...
 uint32 /*uiSender*/, uint32 uiAction) 
        ...
        if (uiAction == GOSSIP_ACTION_INFO_DEF + 1) 
	{
            ...
            uint8 msg = pPlayer->CanStoreNewItem(NULL_BAG, NULL_SLOT, dest,
 24226, 1, false);
 ...
 && !pPlayer->HasItemCount(24226, 1, true))
