...
Position const IgnitionPositions[2][21] =
{
    ...
    {  // Right Side
        ...
        */
        ...
        class npc_magmaws_head : public CreatureScript
        {
        public:
            npc_magmaws_head() : CreatureScript("npc_magmaws_head") { }

            CreatureAI* GetAI(Creature* creature) const
            {
                return new npc_magmaws_headAI (creature);
            }

            struct npc_magmaws_headAI : public ScriptedAI
            {
                npc_magmaws_headAI(Creature* creature) : ScriptedAI(creature)
                {
                    instance = creature->GetInstanceScript();
        ...
        public:
            ...
            {
                npc_pillar_of_flame_triggerAI(Creature* creature) : ScriptedAI(creature),Intialized(false) { }
