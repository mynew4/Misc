...
public:
    ...
    private:
        ...
        {
            me->DespawnOrUnsummon(NPC_ABBERATON);
            me->DespawnOrUnsummon(NPC_PRIME_SUBJECT);
            me->DespawnOrUnsummon(NPC_FLASH_FREEZE);
            me->DespawnOrUnsummon(NPC_VILE_SWILL);
            me->DespawnOrUnsummon(NPC_MAGMA_JET_CONTROLLER);
            me->DespawnOrUnsummon(NPC_ABSOLUTE_ZERO);  
        }
