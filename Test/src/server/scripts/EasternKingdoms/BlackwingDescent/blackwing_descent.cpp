...
public:
    ...
    {
        npc_nefarian_helper_heroicAI(Creature* creature) : ScriptedAI(creature), Intialized(false)
        {
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_drakonid_chainwielderAI (creature);
    }
...
public:
    ...
    {
        npc_ivorocAI(Creature *c) : ScriptedAI(c) {}
...
public:
    ...
    {
        npc_maimgorAI(Creature *c) : ScriptedAI(c) {}
...
class npc_brule_pourpoint: public CreatureScript
{
public:
    npc_brule_pourpoint() : CreatureScript("npc_brule_pourpoint") {}

    struct npc_brule_pourpointAI : public ScriptedAI
    {
        npc_brule_pourpointAI(Creature *c) : ScriptedAI(c) {}
    ...
    CreatureAI* GetAI(Creature* pCreature) const
    {
        return new npc_brule_pourpointAI(pCreature);
    }
...
public:
    ...
    {
        npc_drakonid_slayerAI(Creature *c) : ScriptedAI(c) {}
...
public:
    ...
    {
        npc_drakeadon_mongrelAI(Creature *c) : ScriptedAI(c) {}
...
public:
    ...
    struct mob_nefarian_yellerAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 const diff) 
        {
            if (timer <= diff)
            {
                if (Player* target = me->SelectNearestPlayer(true))
