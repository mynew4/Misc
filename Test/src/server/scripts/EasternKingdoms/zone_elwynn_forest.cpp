...
public:
        ...
        void SetData(uint32 type, uint32 data) 
	{
                ...
                if (Continue == true) 
		{
                    ...
                    Talk(RAND(SAY_PAXTON_NORMAL_1, SAY_PAXTON_NORMAL_2, SAY_PAXTON_NORMAL_3, SAY_PAXTON_NORMAL_4, SAY_PAXTON_NORMAL_5));
                    switch (type) 
		    {
                        case 1:
        ...
        void UpdateAI(const uint32 diff) 
	{
                ...
                if (!me->isInCombat()) 
		{
		    ...
		    {
                        if (me->isMoving()) me->SetSpeed(MOVE_RUN, 2.0f);
                    } 
		    else
            ...
            if (Player* pOwner = me->GetPlayer(*me, me->GetCreatorGUID())) {
                if (RunTimer <= diff) {
                    ...
                    case 0: {
                        ...
                        //I'm really lazy ;)
                        case 0:
                            me->MonsterSay("Que Dieu vous bénisse, héros !", 0, NULL);
                            break;
                        case 1:
