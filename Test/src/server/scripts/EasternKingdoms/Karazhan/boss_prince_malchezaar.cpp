...
//---------Infernal code first
class npc_netherspite_infernal : public CreatureScript
{
public:
    npc_netherspite_infernal() : CreatureScript("npc_netherspite_infernal") { }

    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_netherspite_infernalAI (creature);
    }

    struct npc_netherspite_infernalAI : public ScriptedAI
    {
        npc_netherspite_infernalAI(Creature* creature) : ScriptedAI(creature),
    ...
    struct boss_malchezaarAI : public ScriptedAI
    {
        ...
        void SummonInfernal(const uint32 /*diff*/)
        {
            ...
            if (Infernal)
            {
                ...
                if (point)
                    CAST_AI(npc_netherspite_infernal::npc_netherspite_infernalAI, Infernal->AI())->point=point;
                CAST_AI(npc_netherspite_infernal::npc_netherspite_infernalAI, Infernal->AI())->malchezaar=me->GetGUID();
...
void npc_netherspite_infernal::npc_netherspite_infernalAI::Cleanup()
{
