...
enum Events
{
	...
	EVENT_ENFEEBLING_BLOW	= 11,
	EVENT_TEST				= 12,
};
Position const position[7] =
{	
	{-1055.08f, -601.279f, 835.118f, 0.4208f},	
	{-1055.06f, -563.935f, 835.116f, 5.81653f},	
	{-981.228f, -555.352f, 831.902f, 3.75152f},	
	{-1033.85f, -607.193f, 833.222f, 0.743418f},	
	{-980.955f, -610.725f, 831.903f, 2.29068f},		
	{-1034.14f, -557.533f, 833.45f, 5.50688f},	
	{-1008.82f, -582.948f, 831.901f, 0.731637f}
};
...
public:
    ...
    class spell_waterbomb_SpellScript : public SpellScript
    {		
	PrepareSpellScript(spell_waterbomb_SpellScript);
    ...
    {			
	return new spell_waterbomb_SpellScript();
    }
};
...
public:
	...
	class spell_inferno_ping_SpellScript : public SpellScript	
	{		
		PrepareSpellScript(spell_inferno_ping_SpellScript);		
		bool Validate(SpellInfo const * /* spellEntry*/)		
		{			
			return true;		
		}		
	...
	SpellScript * GetSpellScript() const	
	{		
		return new spell_inferno_ping_SpellScript();	
	}
};
