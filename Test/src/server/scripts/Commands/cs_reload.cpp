...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "holysemu_string",               SEC_ADMINISTRATOR, true,  &HandleReloadTrinityStringCommand,              "", NULL },
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading holysemu_string Table!");
        sObjectMgr->LoadTrinityStrings();
        handler->SendGlobalGMSysMessage("DB table `holysemu_string` reloaded.");
        return true;
    }
