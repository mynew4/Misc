...
enum EPlayerFields
{
    ...
    PLAYER_NO_REAGENT_COST_1                         = UNIT_END + 0x06F7, // Size: 3, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_GLYPH_SLOTS_1                       = UNIT_END + 0x06FB, // Size: 9, Type: INT, Flags: PRIVATE
    PLAYER_FIELD_GLYPHS_1                            = UNIT_END + 0x0701, // Size: 9, Type: INT, Flags: PRIVATE
